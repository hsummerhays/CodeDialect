...
public static class InitialSeed
{
    public static async Task SeedAsync(ApplicationDbContext context, ILogger logger)
    {
        ...
        // --- Dialects ---
        var netFramework = new Dialect
        {
            Name = ".NET Framework 4.8", Language = csharp, RuntimeVersion = "4.8",
            Framework = "ASP.NET Web API 2",
            SyntaxFeatures = new List<string> { "XML Config", "Controllers" }
        };
        var net10 = new Dialect
        {
            Name = ".NET 10", Language = csharp, RuntimeVersion = "10.0",
            Framework = "ASP.NET Core",
            SyntaxFeatures = new List<string> { "Minimal APIs", "Primary Constructors", "Native AOT" }
        };

        var java8 = new Dialect
        {
            Name = "Java 8", Language = java, RuntimeVersion = "1.8",
            SyntaxFeatures = new List<string> { "Streams", "Lambdas" }
        };
        var java21 = new Dialect
        {
            Name = "Java 21", Language = java, RuntimeVersion = "21",
            SyntaxFeatures = new List<string> { "Virtual Threads", "Records", "Structured Concurrency" }
        };

        var jsLegacy = new Dialect
        {
            Name = "Legacy JS", Language = javascript, RuntimeVersion = "ES5",
            SyntaxFeatures = new List<string> { "Callbacks", "var" }
        };
        var jsModern = new Dialect
        {
            Name = "Modern JS (ESM)", Language = javascript, RuntimeVersion = "ES2023",
            SyntaxFeatures = new List<string> { "Async/Await", "ES Modules" }
        };
        var tsModern = new Dialect
        {
            Name = "TypeScript 5.x", Language = typescript, RuntimeVersion = "5.4",
            SyntaxFeatures = new List<string> { "Discriminated Unions", "Mapped Types" }
        };

        var python2 = new Dialect
        {
            Name = "Python 2.7", Language = python, RuntimeVersion = "2.7",
            SyntaxFeatures = new List<string> { "Legacy Print", "ASCII Strings" }
        };
        var python3 = new Dialect
        {
            Name = "Python 3.12", Language = python, RuntimeVersion = "3.12",
            SyntaxFeatures = new List<string> { "Type Hinting", "Dataclasses", "asyncio" }
        };
        ...
        var apiChallenge = new Challenge
        {
            ...
            Category = backend,
            Tags = new List<string> { ".NET", "Architecture", "Minimal API" }
        };
        var apiOld = new ChallengeImplementation
        {
            Challenge = apiChallenge, Dialect = netFramework,
        ...
        {
            Challenge = apiChallenge, Dialect = net10,
        ...
        var concurrencyChallenge = new Challenge
        {
            ...
            Tags = new List<string> { "Java", "Loom", "Concurrency" }
        };
        var java8Concurrency = new ChallengeImplementation
        {
            Challenge = concurrencyChallenge, Dialect = java8,
        ...
        {
            Challenge = concurrencyChallenge, Dialect = java21,
        ...
        var fileIoChallenge = new Challenge
        {
            ...
            Category = backend,
            Tags = new List<string> { "Node.js", "Async", "FileIO" }
        };
        var jsLegacyIo = new ChallengeImplementation
        {
            Challenge = fileIoChallenge, Dialect = jsLegacy,
        ...
        {
            Challenge = fileIoChallenge, Dialect = jsModern,
        ...
        var diChallenge = new Challenge
        {
            ...
            Difficulty = Difficulty.Intermediate,
            Category = architecture,
            Tags = new List<string> { "C#", "Design Patterns", "DI" }
        };
        var diOld = new ChallengeImplementation
        {
            Challenge = diChallenge, Dialect = netFramework,
        ...
        {
            Challenge = diChallenge, Dialect = net10,
            StarterCode = "public class UserService(...) { }",
        ...
        var typeSafeChallenge = new Challenge
        {
            ...
            Difficulty = Difficulty.Advanced,
            Category = frontend,
            Tags = new List<string> { "TypeScript", "Type Safety", "Unions" }
        };
        var tsSafetyImpl = new ChallengeImplementation
        {
            Challenge = typeSafeChallenge, Dialect = tsModern,
        ...
        var pythonDataChallenge = new Challenge
        {
            ...
            Difficulty = Difficulty.Beginner,
            Category = backend,
            Tags = new List<string> { "Python", "Dataclasses", "Type Hinting" }
        };
        var py2Impl = new ChallengeImplementation
        {
            Challenge = pythonDataChallenge, Dialect = python2,
        ...
        {
            Challenge = pythonDataChallenge, Dialect = python3,
